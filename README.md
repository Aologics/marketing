...
| [event-marketing](skills/event-marketing/) | When the user wants help marketing, promoting, or selling tickets to an event — including conferences, summits, workshops, concerts, galas, festivals, community events, virtual events, or hybrid events. |
...
### Events
- `event-marketing` - Event promotion, ticket sales, and access programs
